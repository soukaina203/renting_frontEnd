...
function    About() {
    ...
    return (
        <Fade>
        <section id='About' className="relative pt-20  bg-[#FEFEFE] z-30 lg:pt-[120px] pb-[8rem] lg:pb-[90px] lg:mb-[8rem]  ">
                        ...
                        <div className="p-5 mt-10 lg:mt-0 lg:ml-4">
                            ...
                            <div className="flex flex-col items-center justify-center mb-8 space-y-4 lg:mb-16 sm:flex-row sm:space-y-0 sm:space-x-1">
                                ...
                                <div className="px-4 space-y-4 sm:px-8">
                                    <p className="text-[#E60035] text-lg flex items-center font-Yantramanav-Black ">
                                        <div className='w-12 h-[3px] mr-3 bg-[#E60035] font-Yantramanav-Black'></div>
                                        KNOW ABOUT US</p>
                                    ...
                                    <Link to='/signIn' >
                                        ...
                                        <button className="px-6 mt-2 py-3 w-full lg:w-fit  text-center flex justify-center items-center
