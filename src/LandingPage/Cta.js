...
function Cta() {
    return (
        <div className="relative w-full h-[22rem] bg-hero bg-cover bg-no-repeat">
            <div className="absolute inset-0 bg-red-700 opacity-50"></div>
            <div className='flex items-center justify-center '>

                <div className='relative z-10 flex flex-col items-center gap-[12rem] lg:mt-7 justify-between md:flex-row '>
                    <div className='relative z-10 flex flex-col  pt-[3rem] '>
