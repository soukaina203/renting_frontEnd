  ...
  return (
   ...
   text-white text-center text-surface ">
          <div class="container px-6 pt-6">
            <div class="mb-6 flex flex-col lg:flex-row justify-between  mt-[5rem] lg:mt-0 items-center space-x-2 
              p-[4rem] translate-y-[-50%] bg-[#E81041]  ">

              <h1 className="text-2xl font-bold uppercase p-[1.2rem] text-white
                   bg-[#E81041] font-Yantramanav-Black lg:ml-[2rem]">
                BestCar 
              </h1>
              <div className="ml-4">
              ...
              <div className='flex gap-2 mt-[1.5rem] lg:mt-0 '>
          ...
          <div class="w-full bg-black/5 p-4 text-center font-Yantramanav-Black">
            © 2023 Copyright:
