...
<div id='Ride' className='w-full h-[60rem] md:h-[42rem] lg:h-[24rem] flex flex-col gap-6 '>
            ...
            md:flex-row md:justify-center md:flex-wrap md:content-center md:gap-6  lg:gap-[5rem] lg:mt-[2rem] 
            '> 

                <div className=' w-[14rem] h-[16rem] '> 
            <FaMapMarkerAlt className='text-orange-500 w-[3rem] h-[3rem] ml-auto mr-auto ' />
                ...
                <PiNotepad className='text-orange-500 w-[3rem] h-[3rem] ml-auto mr-auto '/>
                    <h3 className='mt-2 font-bold text-center lg:text-xl'>Pick-Up Date</h3>
                ...
                <div className='w-[14rem] h-[16rem] '> 
                    ...
                    <h3 className='mt-2 font-bold text-center lg:text-xl'>Book A Car</h3>
